...
本项目【还是第一版吧】为软件工程课程实战作业。本团队（AAA3A游戏批发）致力于在计算机科学与工程实践中贯彻最高标准。我们将开发流程与前沿 AI 结对编程深度结合，追求严谨的系统架构与无懈可击的代码底层逻辑，目标是在本学期课程中实现满分通关级别的卓越交付表现。

## 👥 团队角色 (Team Roles)

基于 Scrum 敏捷框架，本团队（3人硬核编制）保持极客式的扁平与高效，核心角色分配如下：
...
| 邹育龙 | 9109223090 | 💻 **Developer** / Dev Team | Core DPS | 核心业务代码编写，主导测试用例构建与自动化集成环境。 |
...
# 3. 安装工程依赖包 (Mock)
npm install  # 或使用对应技术栈的包管理命令，如 pip install
